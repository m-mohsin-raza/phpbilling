...
<div class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <!-- Time & Tasks -->
        <li class="nav-item">
            <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'time-tracking.php' ? 'active' : '' ?>"
                href="time-tracking.php">
        ...
        <li class="nav-item">
            <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'estimates.php' ? 'active' : '' ?>"
                href="estimates.php">
        ...
        <li class="nav-item">
            <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'expenses.php' ? 'active' : '' ?>"
                href="expenses.php">
        ...
        <li class="nav-item">
            <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'projects.php' ? 'active' : '' ?>"
                href="projects.php">
