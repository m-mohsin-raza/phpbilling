...
<head>
    ...
    <title>Dashboard - BixiTech Billing System</title>
    <!-- Bootstrap 5 CSS -->
            ...
            <div class="row mb-4">
                <div class="col-xl-3 col-md-6 mb-3">
                    <div class="stats-card position-relative">
                        ...
                        <div class="stats-value">$127,450</div>
                        ...
                        <div class="card-body">
                            <div class="activity-item">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <strong>Invoice #INV-2023-105 paid</strong>
                                        <br><small class="text-muted">Mansoor LLC - $3,200.00</small>
                                    </div>
                            ...
                            <div class="activity-item">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <strong>New project started</strong>
                                        <br><small class="text-muted">BixiSoft CRM Enhancement</small>
                                    </div>
                            ...
                            <div class="activity-item">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <strong>Time entry logged</strong>
                                        <br><small class="text-muted">3.5 hours on Mansoor Website</small>
                                    </div>
